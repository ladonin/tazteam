...
}//базовая библиотека работы с почтой
...
}//базовая библиотека работы с файлами
...
if (GeneralPageTree::$enable == 1) {
    ...
    if (GeneralSecurity::$submitname == "find_forum") {
        ForumBase::set_cookies_find();
    } else if (GeneralSecurity::$submitname == "clearfindforum") {
        ForumBase::clear_find();
    } else if (GeneralSecurity::$submitname == "find_automarket_auto") {//для любых пользователей
