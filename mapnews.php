...
<a href="http://instorage.org/portfolio/tazteam/news"><strong>Новости</strong></a><br>
<?php
...
{
?>
<a href="http://instorage.org/portfolio/tazteam/news/<?php echo($row['id']);?>"><?php echo($row['name']);?></a><br>
<?php
