...
<html>
<head>
<title>Новости от instorage.org/portfolio/tazteam. Lada Granta стала продаваться с автоматом</title>
...
$.cookie('window_width', $(window).width(), {
    expires: 5,
    path: '/',
});
...
<script type="text/javascript">
timeserver=1393086917;
	$(document).ready(function(){
		general___signature_ajax('news','1','0','0','0');
		general___signature('news','1','0','0','0');});
</script>
...
<td align="left" valign="top">
	...
	<div class="panel_link_dark">Lada Granta стала продаваться с автоматом</div>
	<div class="v_i_b"></div>
	<span class="explanation_dark">Дата размещения: </span><span class="explanation_dark" id="news_date_new"></span>
	<script type="text/javascript">general___date_DMY_show(1355832000,'news_date_new');</script>
	<div class="v_i_b"></div>
...
<div>	
		...
		<tr>
		<td valign="top" align="left" bgcolor="#ffffff">	
			<div style="float:left; margin:0px 20px 10px 0px"><img src="http://140706.selcdn.com/tazteam/_files/images/news/1/1_3.jpeg" width="500" class="refimage news3_3" ></div>
		В салонах дилеров «АвтоВАЗа» появились первые седаны Lada Granta, оснащенные автоматической четырехдиапазонной коробкой передач Jatco и 1,6-литровым мотором мощностью 97 лошадиных сил. Все машины представлены в комплектации «Норма».<br>Рекомендованная производителем стоимость «Гранты» с автоматом составляет 373 тысячи 200 рублей. При этом некоторые дилеры, в частности в Тольятти, предлагают своим клиентам автомобили по цене 399 тысяч 900 рублей.<br>В оснащение автомобилей входят подушки безопасности водителя и переднего пассажира, антиблокировочная система и система помощи при экстренном торможении, электростеклоподъемники передних дверей и кондиционер.<br>До конца года «АвтоВАЗ» планирует выпустить и продать 10 тысяч «Грант» с автоматической коробкой.<br>Ранее сообщалось, что версии бюджетного седана с МКПП получат новую трансмиссию. По мнению руководителя проекта Lada Granta Олега Груненкова, нынешний агрегат обеспечивает «не очень комфортное переключение».</td>
</tr>
</table>	
	...
	<div style="clear:both"></div>
	<div class="v_i_b"></div>	
	<span class="explanation_dark">Просмотров: 1742</span>
	...
	<div class="v_i_b"></div>	
		...
		<td valign="top" align="left" bgcolor="#ffffff">	
		<script type="text/javascript">
	signaturing_page="ne";//для очистки оповещений с этого диалога
	signaturing_id_photo=0;//для очистки оповещений с этого диалога
	general___inputtext_max_lenght_word=25;
	</script>
<div ><div class="panel">
			
	<div style="cursor:pointer" onclick="general___swim_show_hide('dw1_divchat_swim_news_3_1'); general___swim_show_hide('dw1_divchat_swim_button_news_3_1'); general___scroll_object('dw1_divchat_news_3_1',1);">
		<table width="100%" cellpadding="0" cellspacing="0">
		<tr>
		<td align="left">
		<div class="dialog_windows1_9 panel_text_dark">Комментарии</div>
		</td>
		<td align="right">
			<div class="panel_text_dark " id="dw1_divchat_count_messages">1</div>
		</td>
		</tr>
		</table>
	</div>
	...
	<div id="dw1_divchat_swim_button_news_3_1"><a class="link_normal" style="cursor:pointer" onclick="general___swim_show_hide('dw1_divchat_swim_news_3_1'); general___swim_show_hide('dw1_divchat_swim_button_news_3_1'); general___scroll_object('dw1_divchat_news_3_1',1);"><div class="v_i_b"></div>Развернуть</a></div>
	...
	<div id="dw1_divchat_swim_news_3_1" class="padding_right_0">
		<div class="dialog_windows1_1" style="max-height:500px; width:100%;" id="dw1_divchat_news_3_1">
			<div id="dw1_bodychat_news_3_1">
				<script type="text/javascript">
var dwLL1_Flag_stop_news_3_1=new Boolean(false);//устанавливается автоматически
var dwLL1_Flag_downloading_news_3_1=new Boolean(false);//устанавливается автоматически		
var dwLL1_N_current_news_3_1=new Number();//устанавливается ВРУЧНУЮ (дополнительный параметр)
var dwLL1_max_news_3_1=new Number();//устанавливается ВРУЧНУЮ
var dwLL1_adress_news_3_1=new String();//устанавливается ВРУЧНУЮ
...
var dwLL1_scroll_from_bottom_bodychat_news_3_1;//прокрутка от низа тела чата
var dwLL1_scroll_real_news_3_1;//текущее положение в теле чата

$(document).ready(function(){
	$('#dw1_divchat_news_3_1').scroll(function(){//при прокрутке в этом окне
		if ((dwLL1_Flag_stop_news_3_1==false)&&(dwLL1_Flag_downloading_news_3_1==false)){
			dwLL1_scroll_divchat_news_3_1 = $(this).scrollTop();//узнаем прокрутку от верха окна
			if(dwLL1_scroll_divchat_news_3_1==0){ // >>>>>>>>>>>>>>    при каком подъеме к верху начинаем подгружать <<<<<<<<<<<<<<<<
				dwLL1_height_bodychat_news_3_1 = $("#dw1_bodychat_news_3_1").height();
				dwLL1_scroll_from_bottom_bodychat_news_3_1 = dwLL1_height_bodychat_news_3_1;//узнаем прокрутку от низа окна
				if (dwLL1_Flag_stop_news_3_1==false){
					dwLL1_Flag_downloading_news_3_1=true;
					dwLL1_news_3_1();}}}});
	$("#dwLL1_ajax_div_news_3_1").hide();//скрываем пока пустой блок подгрузки сообщений
	general___scroll_object("dw1_divchat_news_3_1",1);});//в самом начале крутим вниз
...
function dwLL1_news_3_1()	{
	var dwLL1_time_on_user_comp_news_3_1 = new Date();
	$.post(
	dwLL1_adress_news_3_1+"?act=ajax_jquery", 
	{
		'id_dialog':'dialog',//идентификатор диалога	
		'N_start':dwLL1_N_current_news_3_1,//с чего начинаем и по убыванию	(здесь не вычитаем, т.к. это число в чатах входит в старт)				
		'limit':dwLL1_max_news_3_1,//предел одной подгрузки
		'database':'news___messages',//база данных
		'condition1':'id_news=1',//условия выборки
		'condition2':'',//условия выборки
		'condition3':'',//условия выборки
		'condition4':'',//условия выборки
		'condition5':'',//условия выборки
		'time_on_user_comp':Math.round(dwLL1_time_on_user_comp_news_3_1.getTime()/1000)//время у пользователя на компьютере
	}, 
	function(responseText){
		if (responseText!="none"){
			$("#dwLL1_ajax_div_news_3_1").show(); //делаем видимым блок с будущим содержимым подгрузки
			$('#dwLL1_ajax_div_news_3_1').html(responseText+$('#dwLL1_ajax_div_news_3_1').html());
			$(document).ready(function(){				
				dwLL1_height_bodychat_news_3_1 = $('#dw1_bodychat_news_3_1').height();//новая высота
				dwLL1_scroll_real_news_3_1 = dwLL1_height_bodychat_news_3_1-dwLL1_scroll_from_bottom_bodychat_news_3_1;//узнаем прокрутку от низа окна
				$('#dw1_divchat_news_3_1').scrollTop(dwLL1_scroll_real_news_3_1);});
			dwLL1_num_text_news_3_1=responseText;
			var dwLL1_findresult_news_3_1=dwLL1_num_text_news_3_1.match(/<\!--(\-?[0-9]{1,})-->$/);
			if (dwLL1_findresult_news_3_1){
				dwLL1_N_current_news_3_1=Number(dwLL1_findresult_news_3_1[1]);}
			dwLL1_Flag_downloading_news_3_1=false;}
		else{
			dwLL1_Flag_stop_news_3_1=true;}
	});}
</script>
<div style="width:100%; text-align:left;" id="dwLL1_ajax_div_news_3_1"></div>				<script type="text/javascript">dialog_windows_detect_width_message('dwLL1_ajax_div_news_3_1');</script>
									<div class="v_i_b"></div>
...
<td align="left" valign="bottom">
		...
		Rhhhjghg sf dg dfdgdgd dgdyj gddgjj fdfjdfj dfgjdgj dgjdg jfs jfs jsf jsf j dgj fsj dg jsfj dfj dg jdgjdgjsfj sfjsfjgsjfsjfssfj j fsh sfj sfjfsj fsj sfj sfjsf. dgjgds fjdg jsfj sfjdg jdt jkjjhd. hhsth sgj gdj gdj dtgj gfj dgjhs
	...
	<script type="text/javascript">general___date_DMYvHM_show(1393080808,'dw1_date_1_dialog');</script>
...
<div class="v_i_b"></div>
					...
					<script type="text/javascript">$("#dw1_divchat_news_3_1").css("overflow-y","scroll");</script>
				<script type="text/javascript">
var dwLN1_Flag_downloading_news_3_1=new Boolean(false);//устанавливается автоматически - можно запрашивать, ожидания подгрузки данных нет
var dialog_windows_1_mouseover_news_3_1=new Boolean(false);



var dwLN1_newmess_news_3_1=new Number();
var dwLN1_adress_news_3_1=new String();//устанавливается ВРУЧНУЮ
...
$(document).ready(function(){
	setInterval("dwLN1_news_3_1()",8000);});

function dwLN1_news_3_1(){
	if (dwLN1_Flag_downloading_news_3_1==false){//alert("=");
		dwLN1_Flag_downloading_news_3_1=true;//идет загрузка - запрет на выполнение, пока не станет false
		var dwLN1_time_on_user_comp_news_3_1 = new Date();
		$.post(
		dwLN1_adress_news_3_1+"?act=ajax_jquery", 
		{
			'id_dialog':'dialog',//идентификатор диалога		
			'newmess':dwLN1_newmess_news_3_1,//с чего начинаем			
			'database':'news___messages',//база данных
			'condition1':'id_news=1',//условия выборки
			'condition2':'',//условия выборки
			'condition3':'',//условия выборки
			'condition4':'',//условия выборки
			'condition5':'',//условия выборки
			'time_on_user_comp':Math.round(dwLN1_time_on_user_comp_news_3_1.getTime()/1000)//время у пользователя на компьютере
		}, 
		function(responseText){//alert(responseText);
			if (responseText!=""){
				if (responseText!='\<\!--1--\>'){
					$("#dwLN1_ajax_div_news_3_1").show(); //делаем видимым блок с будущим содержимым подгрузки
					$('#dwLN1_ajax_div_news_3_1').html($('#dwLN1_ajax_div_news_3_1').html()+responseText);
					if (dialog_windows_1_mouseover_news_3_1==false){
						general___scroll_object("dw1_divchat_news_3_1",1);}}//крутим вниз
					dwLN1_content_news_3_1=responseText;			
					var dwLN1_findresult_news_3_1=dwLN1_content_news_3_1.match(/<\!--(\-?[0-9]{1,})-->$/);
					if (dwLN1_findresult_news_3_1){					
						dwLN1_newmess_news_3_1=dwLN1_findresult_news_3_1[1];						
						$('#dw1_noonewrite_news_3_1').html('');
						$("#dw1_divchat_news_3_1").css("overflow-y","scroll");}}
			dwLN1_Flag_downloading_news_3_1=false;});}}//данные загружены и функция завершает свою работу
</script>
<div class="dialog_windows1_5" id="dwLN1_ajax_div_news_3_1"></div>			</div>
		</div>
		
			<div class="v_i_b"></div>
			<div class="dialog_windows1_9 panel_text_dark_small">Написать комментарий</div>
			<div class="v_i_b"></div>

			<div class="inputtext_null_div_swim">
	<!--всплывающее окно смайлов-->
	<div id="general___inputtext_smiles_div_swim" class="inputtext_smiles_div_swim" onMouseOver="general___inputtext('smiles','on');" onMouseOut="general___inputtext('smiles','off');">				
...
<td width="25" height="25" style="cursor:pointer;"></td>						
	...
	<!--//всплывающее окно смайлов-->
	<!--всплывающее окно мемов-->
	<div id="general___inputtext_ifaces_div_swim" class="inputtext_ifaces_div_swim"	onMouseOver="general___inputtext('ifaces','on');" onMouseOut="general___inputtext('ifaces','off');">
	<div style="background-color:#ffffff;">
<table cellpadding="0" cellspacing="5" border="0">
<tr>
...
<td width="40" height="40" style="cursor:pointer;"></td>		
	...
	<!--//всплывающее окно мемов-->
	<!--всплывающее окно редактора текста-->
	<div id="general___inputtext_redactor_div_swim" class="inputtext_redactor_div_swim"	onMouseOver="general___inputtext('redactor','on');" onMouseOut="general___inputtext('redactor','off');">
	<div style="background-color:#ffffff;">
<table cellpadding="0" cellspacing="2" border="0">
<tr>
<td width="25" height="25" style="cursor:pointer; background-color:#ffffff;" onclick="general___inputtextincludetag('inputtexttextareadialog', 'size=1','text')" valign="middle" align="center" class="inputtexttextareadialogsize"><span style="font-size: 11px; font-family:Times New Roman;">T</span></td>
<td width="25" height="25" style="cursor:pointer; background-color:#ffffff;" onclick="general___inputtextincludetag('inputtexttextareadialog', 'size=2','text')" valign="middle" align="center" class="inputtexttextareadialogsize"><span style="font-size: 13px; font-family:Times New Roman;">T</span></td>
<td width="25" height="25" style="cursor:pointer; background-color:#ffffff;" onclick="general___inputtextincludetag('inputtexttextareadialog', 'size=3','text')" valign="middle" align="center" class="inputtexttextareadialogsize"><span style="font-size: 15px; font-family:Times New Roman;">T</span></td>
<td width="25" height="25" style="cursor:pointer; background-color:#ffffff;" onclick="general___inputtextincludetag('inputtexttextareadialog', 'size=4','text')" valign="middle" align="center" class="inputtexttextareadialogsize"><span style="font-size: 19px; font-family:Times New Roman;">T</span></td>
<td width="25" height="25" style="cursor:pointer; background-color:#ffffff;" onclick="general___inputtextincludetag('inputtexttextareadialog', 'size=5','text')" valign="middle" align="center" class="inputtexttextareadialogsize"><span style="font-size: 23px; font-family:Times New Roman;">T</span></td>
</tr>
</table>

<table cellpadding="0" cellspacing="2" border="0">
<tr>
<td width="25" height="25" style="background-color:#474747; cursor:pointer;" onclick="general___inputtextincludetag('inputtexttextareadialog', 'color=gray','text')"></td>
<td width="25" height="25" style="background-color:#1d7c31; cursor:pointer;" onclick="general___inputtextincludetag('inputtexttextareadialog', 'color=green','text')"></td>
<td width="25" height="25" style="background-color:#6b1d7c; cursor:pointer;" onclick="general___inputtextincludetag('inputtexttextareadialog', 'color=purple','text')"></td>
<td width="25" height="25" style="background-color:#6c9141; cursor:pointer;" onclick="general___inputtextincludetag('inputtexttextareadialog', 'color=olive','text')"></td>
<td width="25" height="25" style="background-color:#138e93; cursor:pointer;" onclick="general___inputtextincludetag('inputtexttextareadialog', 'color=aqua','text')"></td>
</tr>
<tr>
<td width="25" height="25" style="background-color:#649bd6; cursor:pointer;" onclick="general___inputtextincludetag('inputtexttextareadialog', 'color=light_blue','text')"></td>
<td width="25" height="25" style="background-color:#d3cc00; cursor:pointer;" onclick="general___inputtextincludetag('inputtexttextareadialog', 'color=yellow','text')"></td>
<td width="25" height="25" style="background-color:#103ab3; cursor:pointer;" onclick="general___inputtextincludetag('inputtexttextareadialog', 'color=blue','text')"></td>
<td width="25" height="25" style="background-color:#c26400; cursor:pointer;" onclick="general___inputtextincludetag('inputtexttextareadialog', 'color=orange','text')"></td>
<td width="25" height="25" style="background-color:#b71919; cursor:pointer;" onclick="general___inputtextincludetag('inputtexttextareadialog', 'color=red','text')"></td>
</tr>
<tr>
...
<div style="clear:both"></div>
<div class="inputtext_url_img_main" onmouseover="general___inputtext_block_swims();" onclick="general___inputtextincludetag('inputtexttextareadialog', 'link','text');" title="ссылка" style="cursor:pointer;"></div>
<div class="inputtext_quote_img_main" onmouseover="general___inputtext_block_swims();"  onclick="general___inputtextincludetag('inputtexttextareadialog', 'quote','text');" title="цитата" style="cursor:pointer;"></div>
<div class="inputtext_redactor_img_main" onMouseOver="general___inputtext('redactor','on');" onMouseOut="general___inputtext('redactor','off');" title="редактор текста" style="cursor:pointer;"></div>
<div class="inputtext_smiles_img_main" onMouseOver="general___inputtext('smiles','on');" onMouseOut="general___inputtext('smiles','off');" title="смайлы" style="cursor:pointer;"></div>
<div class="inputtext_ifaces_img_main" onMouseOver="general___inputtext('ifaces','on');" onMouseOut="general___inputtext('ifaces','off');" title="мемы" style="cursor:pointer;"></div>
<div class="inputtext_video_img_main" onmouseover="general___inputtext_block_swims();" onclick="general___inputtextincludetag('inputtexttextareadialog', 'video','text');" title="видео" style="cursor:pointer;"></div>
<div style="clear:both"></div>

			<div class="v_i_b"></div>
			<textarea maxlength="1000" class="inputtexttextarea" id="inputtexttextareadialog" name="inputtexttextarea" onselect='savesel(this)' onchange='savesel(this)' onclick='savesel(this)' onfocus='savesel(this)'></textarea>		
			<input value="" type="hidden" name="inputtexthtml" id="inputtexthtml">
			<div class="v_i_b"></div>
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
			<td align="left" width="1%"> 		
				<div class="submit_send" style="cursor:pointer;" onclick="general___dialog_windows_1_send_message('news_3_1','inputtexttextareadialog','inputtexthtml','news___messages','3','5','4','2','5','1','','','','','','','','','','id_news=1','','','','','ne','0','news','1','0','0','0','0');"></div>
			</td>
			<td align="left" width="99%">
				<div class="padding_left_10"><a class="link_normal" onclick="general___swim_hide('dw1_divchat_swim_news_3_1'); general___swim_show_hide('dw1_divchat_swim_button_news_3_1');">Свернуть</a></div>
			 </td>
			</tr>
			</table>
				</div>
	<script type="text/javascript">
			general___swim_hide('dw1_divchat_swim_button_news_3_1');
		</script>
...
<div style="clear:both"></div>
	...
	<div class="panel_link_dark">Другие новости:</div>
	<div class="v_i_b"></div>
		<table cellpadding="0" cellspacing="0" style="width:50%; float:left; padding-bottom:10px;">
	<tr>
	<td valign="top" width="100" align="left">
			<a href="http://mapstore.org/my_portfolio/tazteam.net/news/254"><img src="http://140706.selcdn.com/tazteam/_files/images/news/254/1_2.jpeg" width="100" height="100" class="refimage"></a>
	</td>
	...
	<tr>
	<td valign="top" width="100" align="left">
			<a href="http://mapstore.org/my_portfolio/tazteam.net/news/252"><img src="http://140706.selcdn.com/tazteam/_files/images/news/252/1_2.jpeg" width="100" height="100" class="refimage"></a>
	</td>
	<td valign="top" align="left">
		<div  style="width:320px; overflow:hidden;  padding:5px 10px 5px 10px;">
	...
	<tr>
	<td valign="top" width="100" align="left">
			<a href="http://mapstore.org/my_portfolio/tazteam.net/news/194"><img src="http://140706.selcdn.com/tazteam/_files/images/news/194/1_2.jpeg" width="100" height="100" class="refimage"></a>
	</td>
	<td valign="top" align="left">
		<div  style="width:320px; overflow:hidden;  padding:5px 10px 5px 10px;">
	...
	<tr>
	<td valign="top" width="100" align="left">
			<a href="http://mapstore.org/my_portfolio/tazteam.net/news/251"><img src="http://140706.selcdn.com/tazteam/_files/images/news/251/1_2.jpeg" width="100" height="100" class="refimage"></a>
	</td>
	<td valign="top" align="left">
		<div  style="width:320px; overflow:hidden;  padding:5px 10px 5px 10px;">
	...
	<tr>
	<td valign="top" width="100" align="left">
			<a href="http://mapstore.org/my_portfolio/tazteam.net/news/299"><img src="http://140706.selcdn.com/tazteam/_files/images/news/299/1_2.jpeg" width="100" height="100" class="refimage"></a>
	</td>
	<td valign="top" align="left">
		<div  style="width:320px; overflow:hidden;  padding:5px 10px 5px 10px;">
	...
	<tr>
	<td valign="top" width="100" align="left">
			<a href="http://mapstore.org/my_portfolio/tazteam.net/news/244"><img src="http://140706.selcdn.com/tazteam/_files/images/news/244/1_2.jpeg" width="100" height="100" class="refimage"></a>
	</td>
	<td valign="top" align="left">
		<div  style="width:320px; overflow:hidden;  padding:5px 10px 5px 10px;">
	...
	<tr>
	<td valign="top" width="100" align="left">
			<a href="http://mapstore.org/my_portfolio/tazteam.net/news/176"><img src="http://140706.selcdn.com/tazteam/_files/images/news/176/1_2.jpeg" width="100" height="100" class="refimage"></a>
	</td>
	<td valign="top" align="left">
		<div  style="width:320px; overflow:hidden;  padding:5px 10px 5px 10px;">
	...
	<tr>
	<td valign="top" width="100" align="left">
			<a href="http://mapstore.org/my_portfolio/tazteam.net/news/68"><img src="http://140706.selcdn.com/tazteam/_files/images/news/68/1_2.jpeg" width="100" height="100" class="refimage"></a>
	</td>
	<td valign="top" align="left">
		<div  style="width:320px; overflow:hidden;  padding:5px 10px 5px 10px;">
	...
	<tr>
	<td valign="top" width="100" align="left">
			<a href="http://mapstore.org/my_portfolio/tazteam.net/news/116"><img src="http://140706.selcdn.com/tazteam/_files/images/news/116/1_2.jpeg" width="100" height="100" class="refimage"></a>
	</td>
	<td valign="top" align="left">
		<div  style="width:320px; overflow:hidden;  padding:5px 10px 5px 10px;">
	...
	<tr>
	<td valign="top" width="100" align="left">
			<a href="http://mapstore.org/my_portfolio/tazteam.net/news/146"><img src="http://140706.selcdn.com/tazteam/_files/images/news/146/1_2.jpeg" width="100" height="100" class="refimage"></a>
	</td>
	<td valign="top" align="left">
		<div  style="width:320px; overflow:hidden;  padding:5px 10px 5px 10px;">
	...
	<tr>
	<td valign="top" width="100" align="left">
			<a href="http://mapstore.org/my_portfolio/tazteam.net/news/54"><img src="http://140706.selcdn.com/tazteam/_files/images/news/54/1_2.jpeg" width="100" height="100" class="refimage"></a>
	</td>
	<td valign="top" align="left">
		<div  style="width:320px; overflow:hidden;  padding:5px 10px 5px 10px;">
	...
	<tr>
	<td valign="top" width="100" align="left">
			<a href="http://mapstore.org/my_portfolio/tazteam.net/news/234"><img src="http://140706.selcdn.com/tazteam/_files/images/news/234/1_2.jpeg" width="100" height="100" class="refimage"></a>
	</td>
	<td valign="top" align="left">
		<div  style="width:320px; overflow:hidden;  padding:5px 10px 5px 10px;">
	...
	<tr>
	<td valign="top" width="100" align="left">
			<a href="http://mapstore.org/my_portfolio/tazteam.net/news/202"><img src="http://140706.selcdn.com/tazteam/_files/images/news/202/1_2.jpeg" width="100" height="100" class="refimage"></a>
	</td>
	<td valign="top" align="left">
		<div  style="width:320px; overflow:hidden;  padding:5px 10px 5px 10px;">
	...
	<tr>
	<td valign="top" width="100" align="left">
			<a href="http://mapstore.org/my_portfolio/tazteam.net/news/296"><img src="http://140706.selcdn.com/tazteam/_files/images/news/296/1_2.jpeg" width="100" height="100" class="refimage"></a>
	</td>
	<td valign="top" align="left">
		<div  style="width:320px; overflow:hidden;  padding:5px 10px 5px 10px;">
