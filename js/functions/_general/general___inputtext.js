...
function general___inputtextconverttags_smiles(text){
	text=text.replace(/:cry:/gm,"<img src='http://quitec.org/images/_general/inputtext/smiles/cry.gif' class='smile'>");	
	text=text.replace(/:D:/gm,"<img src='http://quitec.org/images/_general/inputtext/smiles/D.gif' class='smile'>");		
	text=text.replace(/:fear:/gm,"<img src='http://quitec.org/images/_general/inputtext/smiles/fear.gif' class='smile'>");	
	text=text.replace(/:think:/gm,"<img src='http://quitec.org/images/_general/inputtext/smiles/think.gif' class='smile'>");	
	text=text.replace(/:no:/gm,"<img src='http://quitec.org/images/_general/inputtext/smiles/no.gif' class='smile'>");
	text=text.replace(/:wacko:/gm,"<img src='http://quitec.org/images/_general/inputtext/smiles/wacko.gif' class='smile'>");
	text=text.replace(/:smile:/gm,"<img src='http://quitec.org/images/_general/inputtext/smiles/smile.gif' class='smile'>");
	text=text.replace(/:thanks:/gm,"<img src='http://quitec.org/images/_general/inputtext/smiles/thanks.gif' class='smile'>");
	text=text.replace(/:good:/gm,"<img src='http://quitec.org/images/_general/inputtext/smiles/good.gif' class='smile'>");
	text=text.replace(/:palms:/gm,"<img src='http://quitec.org/images/_general/inputtext/smiles/palms.gif' class='smile'>");
	text=text.replace(/:fury:/gm,"<img src='http://quitec.org/images/_general/inputtext/smiles/fury.gif' class='smile'>");
	text=text.replace(/:firtoy:/gm,"<img src='http://quitec.org/images/_general/inputtext/smiles/firtoy.gif' class='smile'>");
	return text;}

function general___inputtextconverttags_ifaces(text){
	text=text.replace(/:yaoming:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/yaoming.gif' class='iface'>");
	text=text.replace(/:yaoming2:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/yaoming2.gif' class='iface'>");
	text=text.replace(/:yaoming3:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/yaoming3.gif' class='iface'>");
	text=text.replace(/:yaowoman:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/yaowoman.gif' class='iface'>");
	text=text.replace(/:yaowoman2:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/yaowoman2.gif' class='iface'>");
	text=text.replace(/:yaowoman3:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/yaowoman3.gif' class='iface'>");
	text=text.replace(/:men:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/men.gif' class='iface'>");
	text=text.replace(/:men2:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/men2.gif' class='iface'>");
	text=text.replace(/:men3:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/men3.gif' class='iface'>");
	text=text.replace(/:men4:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/men4.gif' class='iface'>");
	text=text.replace(/:men5:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/men5.gif' class='iface'>");
	text=text.replace(/:pokerface:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/pokerface.gif' class='iface'>");
	text=text.replace(/:pokerface2:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/pokerface2.gif' class='iface'>");
	text=text.replace(/:pokerface3:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/pokerface3.gif' class='iface'>");
	text=text.replace(/:people:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people.gif' class='iface'>");
	text=text.replace(/:cerealguy:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/cerealguy.gif' class='iface'>");
	text=text.replace(/:people2:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people2.gif' class='iface'>");
	text=text.replace(/:people3:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people3.gif' class='iface'>");
	text=text.replace(/:people4:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people4.gif' class='iface'>");
	text=text.replace(/:people5:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people5.gif' class='iface'>");
	text=text.replace(/:people6:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people6.gif' class='iface'>");
	text=text.replace(/:people7:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people7.gif' class='iface'>");
	text=text.replace(/:people8:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people8.gif' class='iface'>");
	text=text.replace(/:people9:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people9.gif' class='iface'>");
	text=text.replace(/:people10:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people10.gif' class='iface'>");
	text=text.replace(/:people11:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people11.gif' class='iface'>");
	text=text.replace(/:people12:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people12.gif' class='iface'>");
	text=text.replace(/:people13:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people13.gif' class='iface'>");
	text=text.replace(/:people14:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people14.gif' class='iface'>");
	text=text.replace(/:people15:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people15.gif' class='iface'>");
	text=text.replace(/:people16:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people16.gif' class='iface'>");
	text=text.replace(/:people17:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people17.gif' class='iface'>");
	text=text.replace(/:people18:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people18.gif' class='iface'>");
	text=text.replace(/:people19:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people19.gif' class='iface'>");
	text=text.replace(/:people20:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people20.gif' class='iface'>");
	text=text.replace(/:people21:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people21.gif' class='iface'>");
	text=text.replace(/:people22:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people22.gif' class='iface'>");
	text=text.replace(/:people23:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people23.gif' class='iface'>");
	text=text.replace(/:people24:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people24.gif' class='iface'>");
	text=text.replace(/:people25:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people25.gif' class='iface'>");
	text=text.replace(/:people26:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people26.gif' class='iface'>");
	text=text.replace(/:people27:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people27.gif' class='iface'>");
	text=text.replace(/:people28:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people28.gif' class='iface'>");
	text=text.replace(/:people29:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/people29.gif' class='iface'>");
	text=text.replace(/:rageguy:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/rageguy.gif' class='iface'>");
	text=text.replace(/:rageguy2:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/rageguy2.gif' class='iface'>");
	text=text.replace(/:cat:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/cat.gif' class='iface'>");
	text=text.replace(/:cat2:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/cat2.gif' class='iface'>");
	text=text.replace(/:cat3:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/cat3.gif' class='iface'>");
	text=text.replace(/:cat4:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/cat4.gif' class='iface'>");
	text=text.replace(/:cat5:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/cat5.gif' class='iface'>");
	text=text.replace(/:cat6:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/cat6.gif' class='iface'>");
	text=text.replace(/:cat7:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/cat7.gif' class='iface'>");
	text=text.replace(/:cat8:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/cat8.gif' class='iface'>");
	text=text.replace(/:ololosh:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/ololosh.gif' class='iface'>");
	text=text.replace(/:ololosh2:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/ololosh2.gif' class='iface'>");
	text=text.replace(/:ololosh3:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/ololosh3.gif' class='iface'>");
		
	text=text.replace(/:troll:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/troll.gif' class='iface'>");			
	text=text.replace(/:troll2:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/troll2.gif' class='iface'>");			
	text=text.replace(/:troll3:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/troll3.gif' class='iface'>");


	text=text.replace(/:troll4:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/troll4.gif' class='iface'>");
	text=text.replace(/:troll5:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/troll5.gif' class='iface'>");
	text=text.replace(/:troll6:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/troll6.gif' class='iface'>");
	text=text.replace(/:troll7:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/troll7.gif' class='iface'>");
	text=text.replace(/:troll8:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/troll8.gif' class='iface'>");
	text=text.replace(/:troll9:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/troll9.gif' class='iface'>");
	text=text.replace(/:troll10:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/troll10.gif' class='iface'>");
	text=text.replace(/:troll11:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/troll11.gif' class='iface'>");
	text=text.replace(/:troll12:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/troll12.gif' class='iface'>");
	text=text.replace(/:troll13:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/troll13.gif' class='iface'>");
	text=text.replace(/:troll14:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/troll14.gif' class='iface'>");


	text=text.replace(/:memface:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/memface.gif' class='iface'>");
	text=text.replace(/:memface2:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/memface2.gif' class='iface'>");
	text=text.replace(/:memface3:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/memface3.gif' class='iface'>");
	text=text.replace(/:memface4:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/memface4.gif' class='iface'>");
	text=text.replace(/:memface5:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/memface5.gif' class='iface'>");
	text=text.replace(/:memface6:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/memface6.gif' class='iface'>");
	text=text.replace(/:memface7:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/memface7.gif' class='iface'>");
	text=text.replace(/:memface8:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/memface8.gif' class='iface'>");
	text=text.replace(/:memface9:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/memface9.gif' class='iface'>");
	text=text.replace(/:memface10:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/memface10.gif' class='iface'>");
	text=text.replace(/:memface11:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/memface11.gif' class='iface'>");
	text=text.replace(/:memface12:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/memface12.gif' class='iface'>");

	text=text.replace(/:car:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car.gif' class='iface'>");
	text=text.replace(/:car2:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car2.gif' class='iface'>");
	text=text.replace(/:car3:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car3.gif' class='iface'>");
	text=text.replace(/:car4:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car4.gif' class='iface'>");
	text=text.replace(/:car5:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car5.gif' class='iface'>");
	text=text.replace(/:car6:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car6.gif' class='iface'>");
	text=text.replace(/:car7:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car7.gif' class='iface'>");
	text=text.replace(/:car8:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car8.gif' class='iface'>");
	text=text.replace(/:car9:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car9.gif' class='iface'>");
	text=text.replace(/:car10:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car10.gif' class='iface'>");
	text=text.replace(/:car11:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car11.gif' class='iface'>");
	text=text.replace(/:car12:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car12.gif' class='iface'>");
	text=text.replace(/:car13:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car13.gif' class='iface'>");
	text=text.replace(/:car14:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car14.gif' class='iface'>");
	text=text.replace(/:car15:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car15.gif' class='iface'>");
	text=text.replace(/:car16:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car16.gif' class='iface'>");
	text=text.replace(/:car17:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car17.gif' class='iface'>");
	text=text.replace(/:car18:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car18.gif' class='iface'>");
	text=text.replace(/:car19:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car19.gif' class='iface'>");
	text=text.replace(/:car20:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car20.gif' class='iface'>");
	text=text.replace(/:car21:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car21.gif' class='iface'>");
	text=text.replace(/:car22:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car22.gif' class='iface'>");
	text=text.replace(/:car23:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car23.gif' class='iface'>");
	text=text.replace(/:car24:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car24.gif' class='iface'>");
	text=text.replace(/:car25:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car25.gif' class='iface'>");
	text=text.replace(/:car26:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car26.gif' class='iface'>");
	text=text.replace(/:car27:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car27.gif' class='iface'>");
	text=text.replace(/:car28:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car28.gif' class='iface'>");
	text=text.replace(/:car29:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car29.gif' class='iface'>");
	text=text.replace(/:car30:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car30.gif' class='iface'>");
	text=text.replace(/:car31:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car31.gif' class='iface'>");
	text=text.replace(/:car32:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car32.gif' class='iface'>");
	text=text.replace(/:car33:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/car33.gif' class='iface'>");

	text=text.replace(/:taz:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/taz.gif' class='iface'>");
	text=text.replace(/:taz2:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/taz2.gif' class='iface'>");
	text=text.replace(/:taz3:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/taz3.gif' class='iface'>");
	text=text.replace(/:taz4:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/taz4.gif' class='iface'>");
	text=text.replace(/:taz5:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/taz5.gif' class='iface'>");
	text=text.replace(/:taz6:/gm,"<img src='http://quitec.org/images/_general/inputtext/ifaces/taz6.gif' class='iface'>");
