...
var general___inputtext_max_lenght_word=30;
...
*/
	...
	text=text.replace(/\[link=([.\s\S]+?)\/link\]/gmi,function(args){//выбираем нужные участки и обрабатываем их своей функцией
		...
		link = link.replace(/\[link=[\s]*([^\]\n\t]]{1,})\][\s]*[\/]{1,}([^\[]{1,})[\s]*\[\/link\]/gmi,'[link=$1]$2[/link]');//убираем лишние символы на месте названия		
...
function general___inputtextconverttags_smiles(text){
	text=text.replace(/:cry:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/smiles/cry.gif' class='smile'>");	
	text=text.replace(/:D:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/smiles/D.gif' class='smile'>");		
	text=text.replace(/:fear:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/smiles/fear.gif' class='smile'>");	
	text=text.replace(/:think:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/smiles/think.gif' class='smile'>");	
	text=text.replace(/:no:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/smiles/no.gif' class='smile'>");
	text=text.replace(/:wacko:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/smiles/wacko.gif' class='smile'>");
	text=text.replace(/:smile:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/smiles/smile.gif' class='smile'>");
	text=text.replace(/:thanks:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/smiles/thanks.gif' class='smile'>");
	text=text.replace(/:good:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/smiles/good.gif' class='smile'>");
	text=text.replace(/:palms:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/smiles/palms.gif' class='smile'>");
	text=text.replace(/:fury:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/smiles/fury.gif' class='smile'>");
	text=text.replace(/:firtoy:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/smiles/firtoy.gif' class='smile'>");
	return text;}

function general___inputtextconverttags_ifaces(text){
	text=text.replace(/:yaoming:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/yaoming.gif' class='iface'>");
	text=text.replace(/:yaoming2:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/yaoming2.gif' class='iface'>");
	text=text.replace(/:yaoming3:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/yaoming3.gif' class='iface'>");
	text=text.replace(/:yaowoman:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/yaowoman.gif' class='iface'>");
	text=text.replace(/:yaowoman2:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/yaowoman2.gif' class='iface'>");
	text=text.replace(/:yaowoman3:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/yaowoman3.gif' class='iface'>");
	text=text.replace(/:men:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/men.gif' class='iface'>");
	text=text.replace(/:men2:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/men2.gif' class='iface'>");
	text=text.replace(/:men3:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/men3.gif' class='iface'>");
	text=text.replace(/:men4:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/men4.gif' class='iface'>");
	text=text.replace(/:men5:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/men5.gif' class='iface'>");
	text=text.replace(/:pokerface:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/pokerface.gif' class='iface'>");
	text=text.replace(/:pokerface2:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/pokerface2.gif' class='iface'>");
	text=text.replace(/:pokerface3:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/pokerface3.gif' class='iface'>");
	text=text.replace(/:people:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people.gif' class='iface'>");
	text=text.replace(/:cerealguy:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/cerealguy.gif' class='iface'>");
	text=text.replace(/:people2:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people2.gif' class='iface'>");
	text=text.replace(/:people3:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people3.gif' class='iface'>");
	text=text.replace(/:people4:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people4.gif' class='iface'>");
	text=text.replace(/:people5:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people5.gif' class='iface'>");
	text=text.replace(/:people6:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people6.gif' class='iface'>");
	text=text.replace(/:people7:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people7.gif' class='iface'>");
	text=text.replace(/:people8:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people8.gif' class='iface'>");
	text=text.replace(/:people9:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people9.gif' class='iface'>");
	text=text.replace(/:people10:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people10.gif' class='iface'>");
	text=text.replace(/:people11:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people11.gif' class='iface'>");
	text=text.replace(/:people12:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people12.gif' class='iface'>");
	text=text.replace(/:people13:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people13.gif' class='iface'>");
	text=text.replace(/:people14:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people14.gif' class='iface'>");
	text=text.replace(/:people15:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people15.gif' class='iface'>");
	text=text.replace(/:people16:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people16.gif' class='iface'>");
	text=text.replace(/:people17:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people17.gif' class='iface'>");
	text=text.replace(/:people18:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people18.gif' class='iface'>");
	text=text.replace(/:people19:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people19.gif' class='iface'>");
	text=text.replace(/:people20:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people20.gif' class='iface'>");
	text=text.replace(/:people21:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people21.gif' class='iface'>");
	text=text.replace(/:people22:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people22.gif' class='iface'>");
	text=text.replace(/:people23:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people23.gif' class='iface'>");
	text=text.replace(/:people24:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people24.gif' class='iface'>");
	text=text.replace(/:people25:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people25.gif' class='iface'>");
	text=text.replace(/:people26:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people26.gif' class='iface'>");
	text=text.replace(/:people27:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people27.gif' class='iface'>");
	text=text.replace(/:people28:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people28.gif' class='iface'>");
	text=text.replace(/:people29:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/people29.gif' class='iface'>");
	text=text.replace(/:rageguy:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/rageguy.gif' class='iface'>");
	text=text.replace(/:rageguy2:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/rageguy2.gif' class='iface'>");
	text=text.replace(/:cat:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/cat.gif' class='iface'>");
	text=text.replace(/:cat2:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/cat2.gif' class='iface'>");
	text=text.replace(/:cat3:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/cat3.gif' class='iface'>");
	text=text.replace(/:cat4:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/cat4.gif' class='iface'>");
	text=text.replace(/:cat5:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/cat5.gif' class='iface'>");
	text=text.replace(/:cat6:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/cat6.gif' class='iface'>");
	text=text.replace(/:cat7:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/cat7.gif' class='iface'>");
	text=text.replace(/:cat8:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/cat8.gif' class='iface'>");
	text=text.replace(/:ololosh:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/ololosh.gif' class='iface'>");
	text=text.replace(/:ololosh2:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/ololosh2.gif' class='iface'>");
	text=text.replace(/:ololosh3:/gm,"<img src='http://mapstore.org/my_portfolio/tazteam.net/images/ifaces/ololosh3.gif' class='iface'>");
	return text;}
...
function general___inputtexttohtml(text,inputnumbertocitate){
	if 	((/[\d\D]/m).test(text)){
		text=general___inputtext_basic(text);
		text=general___inputtextconverttags_citate(text,inputnumbertocitate);
		text=general___inputtextconverttags_smiles(text);
		text=general___inputtextconverttags_ifaces(text);		text=general___inputtextconverttags_formatter(text);
		text=general___inputtextconverttags_href(text);

		text=general___inputtextconverttags_tables(text);		
		text=general___inputtextconverttags_code(text);
		text=general___inputtextconverttags_placing(text);
		...
		text=general___inputtextconverttags_citate(text,inputnumbertocitate);
		text=general___inputtextconverttags_href(text);
		text=general___inputtextconverttags_formatter(text);
		text=general___inputtextconverttags_tables(text);		
		text=general___inputtextconverttags_code(text);
		text=general___inputtextconverttags_placing(text);
		text=general___inputtextconverttags_smiles(text);
		text=general___inputtextconverttags_ifaces(text);
		text=general___inputtextconverttags_ending(text);		
		*/
