...
function users___calendar_set_borndate(day,month,year)	{
...
function users___calendar_set_borndate_changefrommonth (index) {
	...
	else if (index==2)
	{
		...
		if ((yearvisokos%4)==0) {numelement=30;}
		else {numelement=29;}
...
function users___calendar_set_borndate_changefromyear() {
