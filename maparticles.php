...
<a href="<?php echo(GeneralGlobalVars::url);?>/articles"><strong>Статьи</strong></a><br>
<?php


$res=mysql_query("SELECT id,name FROM news where themepage='2' order by id DESC limit 20");
while ($row=mysql_fetch_array($res))
{
?>
<a href="<?php echo(GeneralGlobalVars::url);?>/articles/<?php echo($row['id']);?>"><?php echo($row['name']);?></a><br>
<?php
