...
class GeneralImagesPreload{
	...
	static public function output(){
		foreach(self::$images as $value){
			self::$listimages.="'http://mapstore.org/my_portfolio/tazteam.net/".$value."',";}
		self::$listimages.="'http://mapstore.org/my_portfolio/tazteam.net/images/index/index___top_menu_fon_hover.png'";
