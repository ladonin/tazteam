...
if ((GeneralGetVars::$var1=="photo")&&(GeneralGetVars::$var2==1)&&(!GeneralGetVars::$var3)){
	...
	$text="<li><a href=\"http://instorage.org/portfolio/tazteam/photo/1=1\">".self::$name2."</a></li>"; return($text);}
	...
	if (GeneralGetVars::$var1){//для всех страниц, кроме главной		
		if ((GeneralGetVars::$var2)&&(GeneralGetVars::$var3)&&(GeneralGetVars::$var1!="news")&&(GeneralGetVars::$var1!="articles")) {//если три переменные
			$text="<li><a href=\"http://instorage.org/portfolio/tazteam/".GeneralGetVars::$var1."\">".self::$name1."</a></li>";
			
			if ((GeneralGetVars::$var1=="video")||(GeneralGetVars::$var1=="automarket")||(GeneralGetVars::$var1=="garage")){
				$text.="<span class=\"divider\">/</span><li><a href=\"http://instorage.org/portfolio/tazteam/".GeneralGetVars::$var1."\">".self::$name2."</a></li>";}
			else {
				$text.="<span class=\"divider\">/</span><li><a href=\"http://instorage.org/portfolio/tazteam/".GeneralGetVars::$var1."/".GeneralGetVars::$var2."\">".self::$name2."</a></li>";}
...
if ((GeneralGetVars::$var1==="photo")&&(!GeneralGetVars::$var3)){
	...
	$text="<a href=\"http://instorage.org/portfolio/tazteam/photo/".GeneralGetVars::$var2."=1\">".self::$name2."</a>"; return($text);}
	...
	if (GeneralGetVars::$var1){//для всех страниц, кроме главной		
		if ((GeneralGetVars::$var2)&&(GeneralGetVars::$var3)&&(GeneralGetVars::$var1!=="news")&&(GeneralGetVars::$var1!=="articles")) {//если три переменные
			$text="<a href=\"http://instorage.org/portfolio/tazteam/".GeneralGetVars::$var1."\">".self::$name1."</a>";


			if ((GeneralGetVars::$var1==="video")||(GeneralGetVars::$var1==="automarket")||(GeneralGetVars::$var1==="garage")){
				$text.="<span class=\"divider\"> / </span><a href=\"http://instorage.org/portfolio/tazteam/".GeneralGetVars::$var1."\">".self::$name2."</a>";}
			else {
				$text.="<span class=\"divider\"> / </span><a href=\"http://instorage.org/portfolio/tazteam/".GeneralGetVars::$var1."/".GeneralGetVars::$var2."\">".self::$name2."</a>";}
			...
			$text="<a href=\"http://instorage.org/portfolio/tazteam/".GeneralGetVars::$var1."\">".self::$name1."</a><span class=\"divider\"> / </span>";
			$text.=self::$name2;
		}
		else if ((!GeneralGetVars::$var2)&&(!GeneralGetVars::$var3)){//если только одна переменная
			$text=self::$name1;			
