...
static public function registration($MSQLc){//начальная регистрация пользователя по почте и паролю
	...
	if (self::return_mail_yet_disable($MSQLc,$_POST['UsersMyDataRegistration_mail'])==true){
		...
		<td align='left'>
			...
			<br><br>		
			<a href='http://instorage.org/portfolio/tazteam/performing/registration_final_from_mail.php/".$_POST['UsersMyDataRegistration_mail']."/".$password."' style='font-size:12px;'>Закончить регистрацию и войти в личный кабинет</a>
		</td>
		</tr>
		</table>
