...
static public $params_auth_sn = array(
    'vk' => array(
        ...
        'redirect_uri_enter'  => GeneralGlobalVars::url.'/performing/enter_across_vk.php',// Адрес сайта

        'redirect_uri_registration'  => GeneralGlobalVars::url.'/performing/registration_across_vk.php',// Адрес сайта
        ...
        'redirect_uri_import_main_data'  => GeneralGlobalVars::url.'/performing/import_main_data_across_vk.php',// Адрес сайта
        'redirect_uri_fasten_account'  => GeneralGlobalVars::url.'/performing/fasten_account_to_vk.php'// Адрес сайта
    ),
    'odnoklassniki' => array(
        'client_id'     => '168635560',/////
