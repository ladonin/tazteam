...
static public function redactpassword($MSQLc){	//записываем в свои сообщения собщение в новостях
	if (UsersBase::detect_its_mypage(2)==true){
		...
		UsersMail::$subject="Смена пароля на сайте mapstore.org/my_portfolio/tazteam.net";
		UsersMail::$header.="From: mapstore.org/my_portfolio/tazteam.net <ladonin85@mail.ru>";
		...
		<font style='font-size:12px;'>С уважением, администрация <a href='".GeneralGlobalVars::url."/cabinet/155'>mapstore.org/my_portfolio/tazteam.net</a></font>
		<table cellpadding='0' cellspacing='0' width='100%'><tr><td height='10' align='left'></td></tr></table>
		<font style='font-size:12px;'><a href='".GeneralGlobalVars::url."/cabinet/1'>Разработка сайта</a></font>
		</BODY>\r\n
		</HTML>";
		UsersMail::send();
