...
<td align="left" width="320" valign="top"> 
	...
	<td align="right">
		<input style="border:1px solid #bbbbbb; width:100%; margin:0; font-size:12px;" name="model" value="<?php if (isset($_COOKIE['automarket_find_query_model'])) {
          echo(htmlspecialchars($_COOKIE['automarket_find_query_model'], ENT_QUOTES));
          } ?>">
	</td>
	</tr>
	</table>
	
	<?php /*<div class="v_i_b"></div><table cellpadding="0" cellspacing="0" width="300">
	<tr valign="top" >
	<td width="180" class="link_lead_light">Пробег</td>
	<td align="right">
		<input id="automarket_form_run_int" style="border:1px solid #bbbbbb; width:100%; margin:0; font-size:12px;" maxlength="9" name="run_int" value="<?php if (isset($_COOKIE['automarket_find_query_run_int'])) {if ($_COOKIE['automarket_find_query_run_int']>0){echo($_COOKIE['automarket_find_query_run_int']);}} ?>">
	</td>
	</tr>
	</table>*/?>
	<div class="v_i_b"></div>
	...
	<td align="right">
		<input style="border:1px solid #bbbbbb; width:100%; margin:0; font-size:12px;" maxlength="4" name="year_production" value="<?php if (isset($_COOKIE['automarket_find_query_year_production'])) {if ($_COOKIE['automarket_find_query_year_production']>0){echo($_COOKIE['automarket_find_query_year_production']);}} ?>">
	</td>
	</tr>
	</table>*/?>
...
<td align="left" width="300" valign="top">
	...
	<tr valign="top" >
	<td width="180" class="link_lead_light">Состояние</td>
	<td align="right">
		<select name="state" style="width:100%; margin:0; font-size:12px;">
...
<div class="v_i_b"></div>
	...
	<table cellpadding="0" cellspacing="0" width="300">
	<tr valign="top" >
	<td width="180" class="link_lead_light">Регион продавца</td>
	<td align="right">
		<input style="border:1px solid #bbbbbb; width:100%; margin:0; font-size:12px;" id="automarket_form_region" name="region" maxlength="100" value="<?php if (isset($_COOKIE['automarket_find_query_region'])) {        
        echo(htmlspecialchars($_COOKIE['automarket_find_query_region'], ENT_QUOTES));      
        } ?>">	
	</td>
	</tr>
	</table>
<div class="v_i_b"></div>
	...
	<table cellpadding="0" cellspacing="0" width="300">
	<tr valign="top" >
	<td width="180" class="link_lead_light">Город продавца</td>
	<td align="right">
		<input style="border:1px solid #bbbbbb; width:100%; margin:0; font-size:12px;" id="automarket_form_city" name="city" maxlength="100" value="<?php if (isset($_COOKIE['automarket_find_query_city'])) {
		  
          echo(htmlspecialchars($_COOKIE['automarket_find_query_city'], ENT_QUOTES));} ?>">
	</td>
	</tr>
	</table>
    	<?php /*
	...
	<table cellpadding="0" cellspacing="0" width="300">
	<tr valign="top" >
	<td width="180" class="link_lead_light">Цена</td>
	<td align="right">
		<input id="automarket_form_price_int" style="border:1px solid #bbbbbb; width:100%; margin:0; font-size:12px;" name="price_int" maxlength="9" value="<?php if (isset($_COOKIE['automarket_find_query_price_int'])) {if ($_COOKIE['automarket_find_query_price_int']>0){echo($_COOKIE['automarket_find_query_price_int']);}} ?>">
	</td>
	</tr>
	</table>*/?>
...
<div class="v_i_b"></div>
	...
	<td align="left" valign="middle" class="padding_left_10">	
		<a class="btn btn-warning btn-small" onclick="general___swim_hide('swim_automarket_find_panel');">убрать</a>
	 </td>
	</tr>
	</table>	
...
if (isset($_COOKIE['automarket_find_query_themepage'])){
	if ($_COOKIE['automarket_find_query_themepage']==1){?>
	<script type="text/javascript">
		//general___swim_show_hide('swim_automarket_find_panel_autos');
	</script>
<?php }} ?>
