...
<td align="left">
	<a href="http://mapstore.org/my_portfolio/tazteam.net/automarket/<?php echo(GeneralGetVars::$var2);?>=<?php echo($row['id']);?>" class="btn btn-warning btn-mini">редактировать</a>
</td>
