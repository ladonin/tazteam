...
<div class="v_i_b"></div>			
			...
			<textarea maxlength="5000"  style="height:400px;  width: 874px;" id="automarket_form_content"  name="content" onselect='savesel(this)' onchange='savesel(this)' onclick='savesel(this)' onfocus='savesel(this)'><?php echo(AutomarketSendTopic::$array_data['content_nacked']); ?></textarea>
