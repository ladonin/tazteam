...
<div class="padding_right_10">
	...
	<div style="float:left;"><a href="http://instorage.org/portfolio/tazteam/<?php echo(GeneralGetVars::$var1."/".GeneralGetVars::$var2."/".GeneralGetVars::$var3."=".GeneralGetVars::$num_page);?>" class="btn btn-warning btn-small">отменить</a></div>
