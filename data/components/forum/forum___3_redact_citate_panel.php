...
if (ForumForreg::$status_redactmessagepanel==1){//если статус панели равен 1, то есть есть смысл проверять возможность показа панели редактирования
	...
	<?php } ?>
	<td width="1" valign="middle"><div class="padding_right_10">
		<input value="редактировать" class="btn btn-link btn-small" type="button"  onclick="javascript:location.href='<?php echo(GeneralGlobalVars::url);?>/<?php echo(GeneralGetVars::$var1);?>/<?php echo(GeneralGetVars::$var2);?>/<?php echo(GeneralGetVars::$var3);?>=<?php echo(GeneralGetVars::$num_page);?>/r=<?php echo($current_var1);?>#redact'">
