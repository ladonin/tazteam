...
{
PhotoBase::detect_current_num_page_photo($MSQLc,$row2['page_photo'],$row2['id_photo'],$row2['id_topic'],GeneralGetVars::$var2);?><a href="http://mapstore.org/my_portfolio/tazteam.net/photo/<?php echo(GeneralGetVars::$var2."/".$row2['id_topic']."=".PhotoBase::$current_num_page_photo);?>" class="refimage"><img src="http://140706.selcdn.ru/tazteam/images/photo/<?php echo(GeneralGetVars::$var2."/".$row2['id_topic']."/".$row2['id_photo']."_3.".$row2['format_photo']);?>" width="69" height="69" style="border-right:1px solid #ffffff; border-bottom:1px solid #ffffff;"></a><?php
}
