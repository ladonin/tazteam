...
<td valign="top" width="53" align="left" style="padding:5px 5px 0 5px;">	
	<a href="http://mapstore.org/my_portfolio/tazteam.net/users/<?php echo($row['id_user']);?>"><img src="<?php echo(UsersBase::return_url_photo($row['t_gen_photo'],$row['t_dir_user']."/".$row['id_user']."_2.".$row['t_site_photo_format'],$row['t_sn_photo_url_from_small'],$row['t_sn_photo_url_from_huge'],0));?>" width="50" height="50" class="refimage" style="border-right:3px solid <?php if (UsersBase::$cur_user_online){?>#f09007<?php } else { ?>#eeeeee<?php } ?>"></a>
...
<td valign="top" align="left" style="padding:5px 5px 0 0px;">
		...
		<?php /*if ((UsersMyData::$identified==1)&&(UsersMyData::$id!=$row['id_user'])) { ?>
			<div class="v_i_s"></div>
			<a href="http://mapstore.org/my_portfolio/tazteam.net/users/<?php echo($row['id_user']);?>/dialogs" class="btn btn-success btn-mini"><?php echo(UsersBase::$array_buttons_to_userslists[1]);?></a>
		<?php }*/?>
