...
<table cellpadding="0" cellspacing="0" width="100%">
    <tbody><tr>
            <td align="left">
                <a href="<?php echo(GeneralGlobalVars::url);?>/users/<?php echo(GeneralGetVars::$var2 . "/friends=1"); ?>" class="lead">Друзья (<?php echo(UsersBase::$count_friends); ?>)</a>
...
while ($rowfriends = GeneralMYSQL::fetch_array($resfriends)) {
    ...
    ?><a href="<?php echo(GeneralGlobalVars::url);?>/users/<?php echo($rowfriends['id_user']); ?>"><img src="<?php echo(UsersBase::return_url_photo($rowfriends['gen_photo'], $rowfriends['dir_user'] . "/" . $rowfriends['id_user'] . "_2." . $rowfriends['site_photo_format'], $rowfriends['sn_photo_url_from_small'], $rowfriends['sn_photo_url_from_huge'])); ?>"
