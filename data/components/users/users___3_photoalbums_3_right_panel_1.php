...
<a href="http://instorage.org/portfolio/tazteam/users/<?php echo($row2['id_user']."/photoalbums/".$row2['id_album']."=".UsersPhotoalbumsBase::$current_num_page_photo);?>" class="refimage"><img src="<?php echo("http://140706.selcdn.com/tazteam/_files/images/users/photoalbums/".$row2['dir_album']."/".$row2['id_user']."/".$row2['id_album']."/".$row2['id_photo']."_3.".$row2['format_photo']);?>" width="69" height="69" style="border-bottom:1px solid #ffffff; border-right:1px solid #ffffff;"></a><?php }
GeneralMYSQL::free($res2);?>
<div class="v_i_b"></div>		

<div>Альбом: <a href="http://instorage.org/portfolio/tazteam/users/<?php echo(GeneralGetVars::$var2."/allphotosinalbum/".GeneralGetVars::$var4."=1");?>" class="link_lead_small"><?php echo(GeneralPagetree::$name4);?></a></div>
<div class="v_i_s"></div>
...
shuffle(UsersBase::$array_photoalbums_list);
	...
	?><a href="http://instorage.org/portfolio/tazteam/users/<?php echo(GeneralGetVars::$var2."/allphotosinalbum/".UsersBase::$array_photoalbums_list[$key]['id_album']);?>=1" title="<?php echo(UsersBase::$array_photoalbums_list[$key]['name_album']);?>" class="link_lead_small "><?php echo(UsersBase::$array_photoalbums_list[$key]['name_album']);?></a><div></div>	<?php 
	if ($cv1==10) {break;}
	$cv1++;	}	?>
