...
<table cellpadding="0" cellspacing="0" width="100%">
    <tr>
        <td align="left">
            <a href="<?php echo(GeneralGlobalVars::url);?>/users/<?php echo(GeneralGetVars::$var2 . "/photoalbums=1"); ?>" class="lead">Фотоальбомы <?php /* (<?php  echo(UsersBase::$count_photoalbums);?>) */ ?></a>
        </td>
        <td align="right">
