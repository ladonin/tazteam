<a href="http://instorage.org/portfolio/tazteam/users" class="lead">Другие участники:</a>
<div class="v_i_b"></div>	
<?php
...
<td valign="top" width="150" align="left">	
	<a href="http://instorage.org/portfolio/tazteam/users/<?php echo($row3['id_user']);?>"><img src="<?php echo(UsersBase::return_url_photo($row3['gen_photo'],$row3['dir_user']."/".$row3['id_user']."_2.".$row3['site_photo_format'],$row3['sn_photo_url_from_small'],$row3['sn_photo_url_from_huge']));?>" width="140" height="140" class="img-var"></a>
</td>
<td valign="top" align="left" class="grey">
<div style="padding:5px 10px 5px 0px;">
	<div style="width:280px; margin:0px; overflow:hidden; ">
		<a href="http://instorage.org/portfolio/tazteam/users/<?php echo($row3['id_user']);?>" class="lead"><?php echo(UsersMyData::return_name($row3['gen_login_user'],$row3['site_mail_user'],$row3['gen_name_user'],$row3['gen_surname_user'],$row3['site_login_status']));?></a></div>
