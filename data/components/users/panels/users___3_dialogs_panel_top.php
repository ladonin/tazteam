...
<td align="left">
	...
	<td>
		...
		<?php }
			...
			?>
			<a href="<?php echo(GeneralGlobalVars::url);?>/<?php echo(GeneralGetVars::$var1."/".GeneralGetVars::$var2."/dialogs=".GeneralPagesCounter::$N_cur_current);?>" class="btn btn-primary btn-small">к&nbsp;диалогам</a>		
		<?php } ?>
	</td>	
