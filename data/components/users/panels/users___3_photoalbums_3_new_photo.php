<?php // такое же как и в data\components\photo\panels\photo___3_new_photo.php ?>
<?php 
...
?><div class="v_i_b"></div>
        ...
        <textarea maxlength="1000" style="height:100px; width:831px" id="inputtexttextarea_1<?php echo($current_var4);?>"  name="inputtexttextarea_1" onselect='savesel(this)' onchange='savesel(this)' onclick='savesel(this)' onfocus='savesel(this)'><?php echo($current_var5);?></textarea>
        <div class="v_i_b"></div>
        ...
        <?php
        /*?>
		<div id="new_photo_in_album_1" class="swim_panel ">
			<div class="v_i_b"></div>
			<form method="post" <?php echo($current_var1);?>>
