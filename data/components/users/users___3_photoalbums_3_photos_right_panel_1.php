...
<a href="http://instorage.org/portfolio/tazteam/users/<?php echo(GeneralGetVars::$var2."/photoalbums/".$row2['id_album']."=".UsersPhotoalbumsBase::$current_num_page_photo);?>" class="refimage"><img src="<?php echo("http://140706.selcdn.com/tazteam/_files/images/users/photoalbums/".$row2['dir_album']."/".GeneralGetVars::$var2."/".$row2['id_album']."/".$row2['id_photo']."_3.".$row2['format_photo']);?>" width="70" height="70" style="border:0px;"></a><?php }
...
<div class="v_i_b"></div>
		...
		<div class="v_i_b"></div>			
		<span class="explanation">Автор: </span><a href="http://instorage.org/portfolio/tazteam/users/<?php echo($row['t_id_user']);?>" class="small_dark_link"><?php echo(UsersMyData::return_name($row['t_login_user'],$row['t_mail_user'],$row['t_name_user'],$row['t_surname_user'],$row['t_login_status']));?></a>
		<?php } ?>
		<div class="v_i_b"></div>
