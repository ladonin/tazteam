...
<a href="<?php echo(GeneralGlobalVars::url);?>/users/<?php echo(GeneralGetVars::$var2."/photoalbums/".$row2['id_album']."=".UsersPhotoalbumsBase::$current_num_page_photo);?>" class="refimage"><img src="<?php echo("http://140706.selcdn.ru/tazteam/images/users/photoalbums/".$row2['dir_album']."/".GeneralGetVars::$var2."/".$row2['id_album']."/".$row2['id_photo']."_3.".$row2['format_photo']);?>" width="70" height="70" style="border:0px;"></a><?php }
