<div id="swim_new_announcement" class="swim_panel padding_left_10">
	...
	if (GeneralSecurity::detect_administrator()==true) {//для администраторов
		...
		action="<?php echo(GeneralGetVars::$urltosubmit);?>">
			...
			<td align="left" valign="bottom" class="padding_left_10">	
				<span class="work_width_photo_6 small_link" onclick="general___swim_hide('swim_new_announcement');">убрать</span>
			 </td>
			</tr>
			</table>
