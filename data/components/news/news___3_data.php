...
<?php if (NewsBase::$img1){	?>
	<div style="float:left; margin:0px 20px 10px 0px"><img src="http://140706.selcdn.ru/tazteam/images/<?php echo(GeneralGetVars::$var1);?>/<?php echo($row['id']);?>/<?php echo(NewsBase::$img1);?>" width="500" class="refimage news3_3" <?php /*onclick="swimwin('gallery','news'); news_img_to_gallery(); "*/?>></div>
<?php } ?>
