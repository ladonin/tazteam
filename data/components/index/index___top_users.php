...
while ($row = GeneralMYSQL::fetch_array($res)) {
    ...
    ?><div style="margin-bottom: 10px; float:left;">
        ...
        <div style="float:right; overflow:hidden; width:103px; margin:5px 0 0px 10px;">
            ...
            <img src="http://instorage.org/portfolio/tazteam/images/_general/moneta2.png" width="12" height="16" style="margin-bottom:2px;"><small> <?php echo($row['site_points']); ?></small>
