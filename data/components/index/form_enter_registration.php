...
<div class="ind_19">
	...
	<table cellpadding="0" cellspacing="0" width="100%" onclick="general___swim_show_hide('swim_enter_panel');">
	<tbody><tr>
	<td align="left" class="big_link" style="padding-top:10px; padding-bottom:10px; cursor:pointer;">
		Войти
	</td>
	<td align="right" style="padding-top:10px; padding-bottom:10px; cursor:pointer;">
		<img src="http://instorage.org/portfolio/tazteam/images/_general/general___arrow_left_grey_13x13.png" width="13" height="13" style="border:0px;">
	</td>
	</tr>
	</tbody>
	</table>
...
<div class="ind_19">
	...
	<table cellpadding="0" cellspacing="0" width="100%" onclick="general___swim_show_hide('swim_registration_panel');">
	<tbody><tr>
	<td align="left" class="big_link" style="padding-top:10px; padding-bottom:10px; cursor:pointer;">
		Регистрация
	</td>
...
if ((UsersMydata::$enter_status==3)||(UsersMydata::$send_mail_for_repassword_status==2)||(UsersMydata::$send_mail_for_repassword_status==1)){
	?>
	general___swim_show_hide('swim_enter_panel');
	<?php
}
?>
