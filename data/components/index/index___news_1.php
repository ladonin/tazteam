...
<div class="padding_left_10 padding_right_<?php echo($current_var3); ?>">
    ...
    <a href="http://mapstore.org/my_portfolio/tazteam.net/<?php echo($current_var2); ?>/<?php echo($row['id']); ?>"
       class="lead"><?php
           echo($row['name']);
           ?></a>
    <div class="v_i_b"></div>
    ...
    <p>
        <small>
            <?php echo($row['contentnacked']); ?>...<a href="http://mapstore.org/my_portfolio/tazteam.net/<?php echo($current_var2); ?>/<?php echo($row['id']); ?>" class="link_normal">читать далее</a>
        </small>	</p>
