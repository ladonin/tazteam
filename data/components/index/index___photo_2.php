...
while ($row = GeneralMYSQL::fetch_array($res)) {
    ...
    <div class="photo_item1" style="margin-bottom:10px;">
        <a href="<?php echo(GeneralGlobalVars::url);?>/photo/<?php echo($row['id_section'] . "/" . $row['id_topic'] . "=" . PhotoBase::$current_num_page_photo); ?>"><img src="http://140706.selcdn.ru/tazteam/images/photo/<?php echo($row['id_section'] . "/" . $row['id_topic'] . "/" . $row['id_photo'] . "_10." . $row['format_photo']); ?>" width="220"  alt="" title="" class="img-polaroid">
