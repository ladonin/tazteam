...
while ($row = GeneralMYSQL::fetch_array($res)) {
    ...
    <div class="photo_item1" style="margin-bottom:10px;">
        <a href="http://instorage.org/portfolio/tazteam/photo/<?php echo($row['id_section'] . "/" . $row['id_topic'] . "=" . PhotoBase::$current_num_page_photo); ?>"><img src="http://140706.selcdn.com/tazteam/_files/images/photo/<?php echo($row['id_section'] . "/" . $row['id_topic'] . "/" . $row['id_photo'] . "_10." . $row['format_photo']); ?>" width="220"  alt="" title="" class="img-polaroid">
