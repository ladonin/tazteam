...
while ($row = GeneralMYSQL::fetch_array($res)) {
    ...
    if ($current_var4 == 1) {
        ...
        <div class="photo_item1" style="margin-right:1px; float: left; width:320px;">
            <a href="<?php echo(GeneralGlobalVars::url);?>/photo/<?php echo($row['id_section'] . "/" . $row['id_topic'] . "=" . PhotoBase::$current_num_page_photo); ?>"><?php
        ?><img src="http://140706.selcdn.ru/tazteam/images/photo/<?php echo($row['id_section'] . "/" . $row['id_topic'] . "/" . $row['id_photo'] . "_11." . $row['format_photo']); ?>" 
            ...
            <div class="photo_item2" style="width:300px;">
                <a href="<?php echo(GeneralGlobalVars::url);?>/users/<?php echo($row['id_user']); ?>"><?php echo(UsersMyData::return_name($row['gen_login_user'], $row['site_mail_user'], $row['gen_name_user'], $row['gen_surname_user'], $row['site_login_status'])); ?></a>
            </div>
        </div>
        <?php
    }
    ...
    if (($current_var4 == 2) || ($current_var4 == 3)) {
        ?>
            <div class="photo_item1" style="<?php if ($current_var4 != 3) { ?>margin-bottom:1px;<?php } ?>">
                <a href="<?php echo(GeneralGlobalVars::url);?>/photo/<?php echo($row['id_section'] . "/" . $row['id_topic'] . "=" . PhotoBase::$current_num_page_photo); ?>"><?php ?><img src="http://140706.selcdn.ru/tazteam/images/photo/<?php echo($row['id_section'] . "/" . $row['id_topic'] . "/" . $row['id_photo'] . "_12." . $row['format_photo']); ?>"
    ...
    if (($current_var4 == 4) || ($current_var4 == 5) || ($current_var4 == 6)) {
        ?>
            <div class="photo_item1" style="<?php if ($current_var4 != 6) { ?>margin-bottom:1px;<?php } ?>">
                <a href="<?php echo(GeneralGlobalVars::url);?>/photo/<?php echo($row['id_section'] . "/" . $row['id_topic'] . "=" . PhotoBase::$current_num_page_photo); ?>"><?php ?><img src="http://140706.selcdn.ru/tazteam/images/photo/<?php echo($row['id_section'] . "/" . $row['id_topic'] . "/" . $row['id_photo'] . "_13." . $row['format_photo']); ?>"
