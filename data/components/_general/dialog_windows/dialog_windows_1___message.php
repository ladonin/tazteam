...
<td align="left" valign="top">
	...
	<a href="<?php echo(GeneralGlobalVars::url);?>/users/<?php echo($dialog_windows_1_row['m_id_user']);?>" class="refimage"><img src="<?php
...
<td align="left" valign="top">
	<div class="padding_left_10 padding_right_10">
        ...
        <?php
         if ($dialog_windows_1_row['m_id_user']>0) { ?>
    		<a href="<?php echo(GeneralGlobalVars::url);?>/users/<?php echo($dialog_windows_1_row['m_id_user']);?>" class="link_lead_small"><?php
