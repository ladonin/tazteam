<?php if ((UsersMydata::$enter_status==3)||(UsersMydata::$send_mail_for_repassword_status==2)){
	...
	if (UsersMydata::$enter_status==2){
        UsersMyData::$problems_status=1;	?>
        <p class="text-error">На сайте mapstore.org/my_portfolio/tazteam.net не найдено вашей страницы из VK.com.</p>
        <p class="text-info">Если у вас на mapstore.org/my_portfolio/tazteam.net есть старый аккаунт, войдите на него через почту (или логин) и пароль. Там вы сможете привязать страницу из VK.com.</p>
