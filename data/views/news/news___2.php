...
<a href="<?php echo(GeneralGlobalVars::url);?>/<?php echo(GeneralGetVars::$var1);?><?php if (GeneralGetVars::$num_page) {echo("/".GeneralGetVars::$num_page);}?>" class="link_normal">отменить</a>
