...
<td align="left" class="padding_left_10">
	<a href="http://instorage.org/portfolio/tazteam/<?php echo(GeneralGetVars::$var1);?>/redact=<?php echo($row['id']);?>" class="btn btn-warning btn-mini">редактировать</a>
</td>
<td align="left" class="padding_left_10">
...
<td align="left" valign="top">
	...
	<div class="lead"><a href="http://instorage.org/portfolio/tazteam/<?php echo(GeneralGetVars::$var1);?>=<?php echo(GeneralPagesCounter::$N_cur_to_outer);?>" title="наверх" class="btn btn-primary btn-mini" style="margin-right:5px; margin-bottom:3px;">&#9650;</a> <?php echo($row['name']);?></div>
...
>
	...
	<td valign="top" align="left">
		<div  style="width:320px; overflow:hidden;  padding:5px 10px 5px 10px;">
			<a href="http://instorage.org/portfolio/tazteam/<?php echo(GeneralGetVars::$var1);?>/<?php echo($row2['id']);?>"  class="link_lead " <?php if ($cv1>5){echo("rel=\"nofollow\"");} ?>><?php echo($row2['name']);?></a>
