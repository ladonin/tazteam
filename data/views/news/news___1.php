...
?>
	...
	<td valign="top" width="110" align="left">
		<a href="<?php echo(GeneralGlobalVars::url);?>/<?php echo(GeneralGetVars::$var1);?>/<?php echo($row['id']);?>"><?php		
		if ($row['img']==""){?><img src="<?php echo(GeneralGlobalVars::url);?>/images/_general/general___photo_none_100x100.jpg" width="100" height="100" class="refimage"><?php }
		...
		<a href="<?php echo(GeneralGlobalVars::url);?>/<?php echo(GeneralGetVars::$var1);?>/<?php echo($row['id']);?>" class="lead"><?php echo($row['name']);?></a>
