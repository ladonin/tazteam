...
?>
	...
	<tr>
	<td valign="top" align="center"><a href="http://instorage.org/portfolio/tazteam/photo/<?php echo($row['id_section']);?>=1"><img src="http://instorage.org/portfolio/tazteam/images/photo/photo___section_<?php echo($row['id_section']);?>.png" width="206" height="206" style="border:0px solid #191c20;"></a></td>
	</tr>
	</table>
