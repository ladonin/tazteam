...
?>
	...
	?>
<a href="http://instorage.org/portfolio/tazteam/<?php echo(GeneralGetVars::$var1);?>=<?php echo(GeneralPagesCounter::$N_cur_to_outer);?>" class="btn btn-primary btn-mini" style="margin-bottom:7px; margin-right:5px;" title="наверх">▲</a>
