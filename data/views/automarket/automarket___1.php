                                    ...
                                    <tr>
                                        <td align="left" valign="top">
                                            <div style="width:171px; overflow:hidden;  padding:0px;">
                                                <a href="http://instorage.org/portfolio/tazteam/automarket/<?php echo($row['themepage'] . "/" . $row['id']); ?>" class="lead"><?php echo(AutomarketBase::return_parameters("mark", $row['mark']) . " ");
                    echo($row['model']); ?></a>
                                            </div>
                ...
                ?>    
                                        ...
                                        <td align="left" valign="top">
                                            <div style="padding-left:10px;">
                                                <a href="http://instorage.org/portfolio/tazteam/automarket/<?php echo($row['themepage'] . "/" . $row['id']); ?>"><?php if ($row['img'] == "") { ?><img src="http://instorage.org/portfolio/tazteam/images/_general/general___photo_none_210x160.png" width="210" height="160" class="refimage"/><?php } else {
                                    ...
                                    <tr>
                                        <td align="left" valign="top">
                                            <div style="width:268px; overflow:hidden;  padding:5px 0px;">
                                                <a href="http://instorage.org/portfolio/tazteam/automarket/<?php echo($row['themepage'] . "/" . $row['id']); ?>" class="link_lead_big"><?php echo($row['name']); ?></a>
                                            </div>
                                        </td>
