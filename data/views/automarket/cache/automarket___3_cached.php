...
<?php if ($row['themepage'] != 3) { ?>
    ...
    <?php } else {
        ?>
                                                    <img src="http://instorage.org/portfolio/tazteam/images/_general/general___photo_none_600x400.jpg" width="458"  class="refimage" <?php /* onclick="swimwin('gallery','automarket'); automarket_img_to_gallery(); " */ ?>>
    <?php } ?></div>
                                        </td>
                                    </tr>
                                </table>
