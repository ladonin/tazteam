...
<a href="http://instorage.org/portfolio/tazteam/calculator/2">Расчет времени прохождения дистанции 402 м</a>
    ...
    <li>
<a href="http://instorage.org/portfolio/tazteam/calculator/3">Расчет rs и степени сжатия мотора</a>
    </li> 	    
    <li>
<a href="http://instorage.org/portfolio/tazteam/calculator/4">Расчет степени сжатия для турбо мотора</a>
    </li>
    </ul>
    </div>
