...
<td align="left" width="598" valign="top">
		...
		<a href="<?php echo(GeneralGlobalVars::url);?>/users/<?php echo(GeneralGetVars::$var2."/photoalbums/".$row['id_album']."=".UsersPhotoalbumsBase::$next_num_page_photo);?>"><img style="max-height:588px; max-width:588px; " src="http://140706.selcdn.ru/tazteam/images/users/photoalbums/<?php echo($row['dir_album']."/".GeneralGetVars::$var2."/".$row['id_album']."/".$row['id_photo']."_6.".$row['format_photo']);?>" class="refimage">
		</a></div>	
