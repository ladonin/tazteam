...
<td align="left" width="598" valign="top">
	...
	next_photo_img_url="http://140706.selcdn.com/tazteam/_files/images/users/photoalbums/<?php echo($row['dir_album']);?>/<?php echo(GeneralGetVars::$var2."/".$row['id_album']."/".UsersPhotoalbumsBase::$id_next_photo);?>";
