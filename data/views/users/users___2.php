                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td align="left" width="120" valign="top">
                                <a href="<?php echo(GeneralGlobalVars::url);?>/garage/<?php echo($value['themepage']); ?>/<?php echo($value['id']); ?>" alt="<?php echo(GarageBase::return_parameters("mark", $value['mark']) . " " . $value['model']); ?>"
                ...
                <div class="tabbable"> <!-- Only required for left/right tabs -->
                    <ul class="nav nav-tabs">
                        ...
                        <li style="float:right; padding-top:10px;">                      
                            <img src="<?php echo(GeneralGlobalVars::url);?>/images/_general/moneta2.png" width="12" height="16" style="margin-bottom:2px;"> <b style="color:#000000;"><?php echo($row['site_points']); ?></b>
                        </li> 
                    </ul>
                    <div class="v_i_b"></div>
