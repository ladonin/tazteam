<div class="v_i_b"></div>
<div class="padding_left_10"><a href="http://instorage.org/portfolio/tazteam/automarket<?php if (GeneralGetVars::$num_page) {echo("/".GeneralGetVars::$var2."/".GeneralGetVars::$num_page);}?>" class="small_dark_link">отменить</a></div>
<div class="v_i_b"></div>
