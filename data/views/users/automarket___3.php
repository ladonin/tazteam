...
<td align="left" id="photo_side" valign="top">
	...
	<td align="left" width="50%" valign="middle" rowspan="2">			
		...
		<td width="38" style="background-image: url('http://instorage.org/portfolio/tazteam/images/automarket/automarket___price_triangle38.png');">
		</td>
		</tr>
		</table>			
	</td>
	...
	<?php
		if (AutomarketBase::$img1){	?>
			<img src="http://140706.selcdn.com/tazteam/_files/images/automarket/<?php echo($row['id']);?>/<?php echo(AutomarketBase::$img1);?>" width="<?php echo(AutomarketBase::$width1);?>" height="<?php echo(AutomarketBase::$height1);?>" id="automarket_img_photo_big" class="refimage automarket3_3" <?php /*onclick="swimwin('gallery','automarket'); automarket_img_to_gallery(); "*/?>>
			<script type="text/javascript">
			...
			<script type="text/javascript">
				automarket_img_url="http:\/\/instorage.org/portfolio/tazteam\/images\/_general\/";
