...
<td align="left">
    ...
    <a href="http://instorage.org/portfolio/tazteam/<?php echo(GeneralGetVars::$var1."/".GeneralGetVars::$var2."/photoalbums");?>=<?php echo(GeneralPagesCounter::$N_cur_to_outer);?>" class="btn btn-primary btn-small" title="наверх">▲</a> 
...
while ($row=GeneralMYSQL::fetch_array($res)){
	...
	<tr>
	<td valign="top" align="center"><a href="http://instorage.org/portfolio/tazteam/users/<?php echo(GeneralGetVars::$var2."/photoalbums/".$row['id_album']."=".UsersPhotoalbumsBase::$current_num_page_photo);?>" alt="<?php echo($row['name_photo']);?>"><img src="http://140706.selcdn.com/tazteam/_files/images/users/photoalbums/<?php echo($row['dir_album']."/".GeneralGetVars::$var2."/".$row['id_album']."/".$row['id_photo']."_5.".$row['format_photo']);?>" width="210" height="210"></a></td>
	</tr>
	</table>			
