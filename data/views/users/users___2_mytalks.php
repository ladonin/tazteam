...
if (UsersBase::detect_its_mypage(2)==true){//определяем - наша страница или нет
	...
	foreach(UsersForreg::$array_my_talks as $value){
		...
		<a href="<?php echo(GeneralGlobalVars::url);?>/forum/<?php echo(GeneralPageBasic::$code_section);?>/<?php echo(GeneralPageBasic::$code_topic);?>=1" class="link_normal"><?php echo(GeneralPageBasic::$current_name_topic);?></a>
		<div class="v_i_b"></div>
		<?php
		$cv=1;}}}
	if ($cv==0){ ?>
...
//static public $code_idphoto;		
	...
	foreach(UsersForreg::$array_my_talks as $value){
		...
		if (GeneralPageBasic::$current_name_topic) { ?>
		<a href="<?php echo(GeneralGlobalVars::url);?>/forum/<?php echo(GeneralPageBasic::$code_section);?>" class="link_lead_topic "><?php echo(GeneralPageBasic::$current_name_topic);?></a>
		<div class="v_i_b"></div>
		<?php
		$cv=1;}}}
	if ($cv==0){ ?>
	...
	foreach(UsersForreg::$array_my_talks as $value){
		...
		?>
		<a href="<?php echo(GeneralGlobalVars::url);?>/photo/<?php echo(GeneralPageBasic::$code_section);?>/<?php echo(GeneralPageBasic::$code_topic);?>=<?php echo(GeneralPagesCounter::$N_cur_current);?>" class="link_lead_topic "><?php echo(GeneralPageBasic::$current_name_topic);?> (фото №<?php echo(GeneralPagesCounter::$N_cur_current);?>)</a>
		<div class="v_i_b"></div>
		<?php
		$cv=1;}}}
	if ($cv==0){ ?>
	...
	foreach(UsersForreg::$array_my_talks as $value){
		...
		?>
		<a href="<?php echo(GeneralGlobalVars::url);?>/users/<?php echo(GeneralPageBasic::$code_section);?>/photoalbums/<?php echo(GeneralPageBasic::$code_topic);?>=<?php echo(GeneralPagesCounter::$N_cur_current);?>" class="link_lead_topic "><?php echo(GeneralPageBasic::$current_name_topic);?> (фото №<?php echo(GeneralPagesCounter::$N_cur_current);?>)</a>
		<div class="v_i_b"></div>
		<?php
		$cv=1;}}}
	if ($cv==0){ ?>
	...
	foreach(UsersForreg::$array_my_talks as $value){
		...
		if (GeneralPageBasic::$current_name_topic) { ?>
		<a href="<?php echo(GeneralGlobalVars::url);?>/news/<?php echo(GeneralPageBasic::$code_topic);?>" class="link_lead_topic "><?php echo(GeneralPageBasic::$current_name_topic);?></a>
		<div class="v_i_b"></div>
		<?php
		$cv=1;}}}
	if ($cv==0){ ?>
	...
	foreach(UsersForreg::$array_my_talks as $value){
		...
		if (GeneralPageBasic::$current_name_topic) { ?>
		<a href="<?php echo(GeneralGlobalVars::url);?>/automarket/<?php echo(GeneralPageBasic::$code_section);?>/<?php echo(GeneralPageBasic::$code_topic);?>" class="link_lead_topic "><?php echo(GeneralPageBasic::$current_name_topic);?></a>
		<div class="v_i_b"></div>
		<?php
		$cv=1;}}}
	if ($cv==0){ ?>
	...
	foreach(UsersForreg::$array_my_talks as $value){
		...
		if (GeneralPageBasic::$current_name_topic) { ?>
		<a href="<?php echo(GeneralGlobalVars::url);?>/video/<?php echo(GeneralPageBasic::$code_section);?>/<?php echo(GeneralPageBasic::$code_topic);?>" class="link_lead_topic "><?php echo(GeneralPageBasic::$current_name_topic);?></a>
		<div class="v_i_b"></div>
		<?php
		$cv=1;}}}
	if ($cv==0){ ?>
	...
	foreach(UsersForreg::$array_my_talks as $value){
		...
		if (GeneralPageBasic::$current_name_topic) { ?>
		<a href="<?php echo(GeneralGlobalVars::url);?>/users/<?php echo(GeneralPageBasic::$code_section);?>" class="link_lead_topic "><?php echo(GeneralPageBasic::$current_name_topic);?></a>
		<div class="v_i_b"></div>
		<?php
		$cv=1;}}}
	if ($cv==0){ ?>
	...
	if ($row['indexchat1']){ ?>
		<div class="v_i_b"></div>
		<a href="<?php echo(GeneralGlobalVars::url);?>" class="link_lead black">Главная страница - чат</a>
		<div class="v_i_b"></div>	
	<?php }

	if ($row['shopchat1']){ ?>
		<div class="v_i_b"></div>
		<a href="<?php echo(GeneralGlobalVars::url);?>/shop" class="link_lead black">Автозвук - чат</a>
		<div class="v_i_b"></div>	
	<?php }	
	...
	while($row=GeneralMYSQL::fetch_array($res)) {
		?><a href="<?php echo(GeneralGlobalVars::url);?>/photo/<?php echo($row['id_section']);?>/<?php echo($row['id_topic']);?>/allphotos=1" class="link_normal"><?php echo($row['name_topic']);?></a>
		<div class="v_i_b"></div>
		<?php	
		$cv=1;}
	if ($cv==0){ ?>
	...
	while($row=GeneralMYSQL::fetch_array($res)) { ?>
	<a href="<?php echo(GeneralGlobalVars::url);?>/automarket/<?php echo($row['themepage']);?>/<?php echo($row['id']);?>" class="link_normal">
