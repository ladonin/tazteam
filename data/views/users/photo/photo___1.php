...
<a href="<?php echo(GeneralGlobalVars::url);?>/photo/<?php echo($row['id_section']);?>=1" class="big_link"><img src="<?php echo(GeneralGlobalVars::url);?>/images/photo/photo___section_<?php echo($row['id_section']);?>.png" width="200" height="200" style="border:1px solid #191c20;"></a>
</div></td>
</tr>
</table>
<?php
...
<tr>
<td class="photo1_3">
<a href="<?php echo(GeneralGlobalVars::url);?>/photo/<?php echo($row['id_section']);?>=1" class="big_link"><?php echo($row['name_section']);?></a>
<div class="v_i_s"></div>
...
while ($row2=GeneralMYSQL::fetch_array($res2)){
	...
	?><a href="<?php echo(GeneralGlobalVars::url);?>/photo/<?php echo($row['id_section']."/".$row2['id_topic']."=".PhotoBase::$current_num_page_photo);?>"><img src="http://140706.selcdn.ru/tazteam/images/photo/<?php echo($row['id_section']."/".$row2['id_topic']."/".$row2['id_photo']."_5.".$row2['format_photo']);?>" width="200" height="200" class="refimage"></a><?php
}
?>
</td>
</tr>
