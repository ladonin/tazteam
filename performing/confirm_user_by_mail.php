...
$_GET['get_var1']=GeneralSecurity::real_escape($MSQLc,$_GET['get_var1']);
$_GET['get_var2']=GeneralSecurity::real_escape($MSQLc,$_GET['get_var2']);
...
if (UsersMyData::$identified==0){//только для неидентифицированных	
	UsersBase::confirm_by_mail($MSQLc);
